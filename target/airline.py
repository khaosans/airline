...
def main():
    ...
    os.system('java -jar airline-1.0-SNAPSHOT.jar -print -pretty prettyfile.txt -textFile khaosans/unsort.txt same 123 PDX 03/03/2014 12:00 AM ORD 05/04/2014 1:00 PM')
